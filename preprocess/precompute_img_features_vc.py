...
def process_features(proc_id, out_queue, scanvp_list, args):
    ...
    model, embd_size, model_transforms, model_info = model_utils.load_model(model_name)
    ...
    for scan_id, viewpoint_id in scanvp_list:
        ...
        images = torch.stack([model_transforms(image).to(device) for image in images], 0)
        fts, logits = [], []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vit', default="large")
