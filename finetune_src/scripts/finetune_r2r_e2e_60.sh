...
#SBATCH -o ./out/outfile_60            # send stdout to outfile
#SBATCH -e ./out/errfile_60            # send stderr to errfile
...
JOBID=$SLURM_JOB_ID
LOG=$BDIR/logs/log_finetune_r2r_e2e_60.txt
ob_type=pano
feedback=sample
...
outdir=../datasets/R2R/exprs/finetune/vitbase-finetune-e2e-60
