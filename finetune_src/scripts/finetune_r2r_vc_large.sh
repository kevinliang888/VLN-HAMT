...
#SBATCH -o ./out/outfile1            # send stdout to outfile
#SBATCH -e ./out/errfile1            # send stderr to errfile
...
JOBID=$SLURM_JOB_ID
LOG=$BDIR/logs/log_finetune_r2r_vc_large.txt
ob_type=pano
feedback=sample
...
outdir=../datasets/R2R/exprs/finetune/vitbase-finetune-vclarge
