...
#SBATCH -o ./slurm_outs/outfile_pretrain_vcb            # send stdout to outfile
#SBATCH -e ./slurm_outs/errfile_pretrain_vcb            # send stderr to errfile
...
JOBID=$SLURM_JOB_ID
LOG=$BDIR/logs/log_pretrain_r2r_vc_b.txt
...
CUDA_VISIBLE_DEVICES='0,1,2,3' python -m torch.distributed.launch \
    ...
    --output_dir datasets/R2R/exprs/pretrain/cmt-vitbase-6tasks-vc-b > $LOG