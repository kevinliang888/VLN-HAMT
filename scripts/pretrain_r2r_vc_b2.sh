...
#SBATCH -o ./slurm_outs/outfile_pretrain_vcb2            # send stdout to outfile
#SBATCH -e ./slurm_outs/errfile_pretrain_vcb2            # send stderr to errfile
...
JOBID=$SLURM_JOB_ID
LOG=$BDIR/logs/log_pretrain_r2r_vc_b2.txt

NODE_RANK=0
NUM_GPUS=4
CUDA_VISIBLE_DEVICES='0,1,2,3' python -m torch.distributed.launch \
    --nproc_per_node=${NUM_GPUS} --master_port=65516 --node_rank $NODE_RANK \
